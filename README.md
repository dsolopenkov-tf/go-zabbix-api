...
Install it: `go get github.com/dsolopenkov-tf/go-zabbix-api`
...
import (
	...
	"github.com/dsolopenkov-tf/go-zabbix-api"
)
...
Documentation is available on [godoc.org](https://godoc.org/github.com/dsolopenkov-tf/go-zabbix-api).
